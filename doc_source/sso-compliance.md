...
Third\-party auditors assess the security and compliance of AWS services such as AWS Single Sign\-On \(AWS SSO\) as part of multiple AWS compliance programs\. AWS SSO is now in scope for AWS SOC 1, SOC 2, and SOC 3 reports\. For more information, see [SOC Compliance](https://aws.amazon.com/compliance/soc-faqs/)\.
